...
public class LazyPWLUCSAdapter  extends ArrayAdapter<PWLUCS>{

	private Context context;
	private List<PWLUCS> people;
	private ImageLoader imageLoader;
	private DisplayImageOptions dioptions;

	@Override
	public void add(PWLUCS object) {
		people.add(object);
		super.add(object);
	}

	@Override
	public void addAll(Collection<? extends PWLUCS> collection) {
		people.add((PWLUCS) collection);
		super.addAll(collection);
	}

	public LazyPWLUCSAdapter(Context context,int id,ImageLoader imageLoader,DisplayImageOptions dioptions) {
		super(context, id);
	...
	@Override
	public PWLUCS getItem(int arg0) {
